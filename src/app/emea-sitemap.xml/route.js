/**
 * EMEA Regional Sitemap Generator
 * Fetches all news articles related to EMEA (Europe, Middle East, Africa)
...
export async function GET() {
    ...
    try {
        // Fetch all news articles from EMEA category
        const response = await fetch(
            'https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=EMEA&filters[$or][1][subcategories].data[name][$contains]=EMEA&pagination[pageSize]=1000',
