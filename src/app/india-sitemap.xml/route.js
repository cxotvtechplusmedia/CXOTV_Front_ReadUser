/**
 * India Regional Sitemap Generator
 * Fetches all news articles related to India
...
export async function GET() {
    ...
    try {
        // Fetch all news articles from India category
        const response = await fetch(
            'https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=INDIA&filters[$or][1][subcategories].data[name][$contains]=INDIA&pagination[pageSize]=1000',
