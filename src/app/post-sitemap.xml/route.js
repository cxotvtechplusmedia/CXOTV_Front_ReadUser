/**
 * Post/News Sitemap Generator
 * Fetches all news articles and generates a sitemap
...
export async function GET() {
    ...
    try {
        // Fetch all news articles from API
        const response = await fetch(
            'https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&pagination[pageSize]=1000',
