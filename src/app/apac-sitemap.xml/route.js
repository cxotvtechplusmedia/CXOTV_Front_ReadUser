/**
 * APAC Regional Sitemap Generator
 * Fetches all news articles related to APAC
...
export async function GET() {
    ...
    try {
        // Fetch all news articles from APAC category
        const response = await fetch(
            'https://apicxotv.techplusmedia.com/api/news?populate=*&sort=publishedAt:DESC&filters[$or][0][categories].data[name][$eq]=APAC&filters[$or][1][subcategories].data[name][$contains]=APAC&pagination[pageSize]=1000',
